...
Меня зовут Тимофей — я **BI / Data-аналитик**. Закрываю полный цикл работы с данными: от сбора требований у бизнес-заказчиков и проектирования ETL-процессов до построения дашбордов, прогнозных моделей и аналитических отчётов.
